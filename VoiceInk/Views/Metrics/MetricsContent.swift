...
struct MetricsContent: View {
    private let logger = Logger(subsystem: "com.prakashjoshipax.Cheppu", category: "MetricsContent")
    ...
    private var metricsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 16)], spacing: 16) {
            MetricCard(
                ...
                value: "\(totalCount)",
                detail: "Cheppu sessions completed",
                color: .purple
            )
            ...
            MetricCard(
                ...
                value: averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "Cheppu vs. typing by hand",
                color: .yellow
            )
    ...
    private var heroSubtitle: String {
        guard totalCount > 0 else {
            return "Your Cheppu journey starts with your first recording."
        }
