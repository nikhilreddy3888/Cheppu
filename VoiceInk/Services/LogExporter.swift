...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.cheppu", category: "LogExporter")
    private let subsystem = "com.prakashjoshipax.cheppu"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Cheppu Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Cheppu_Logs_\(timestamp).log"
